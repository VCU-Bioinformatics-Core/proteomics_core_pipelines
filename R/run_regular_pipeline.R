...
run_regular_pipeline <- function(
  ...
  # save to file
  write.csv(intensity_matrix, file.path(out_dirs$data, "imputed_intensity_matrix.csv"))
  flog.info("Imputed intensity matrix written to %s", file.path(out_dirs$data, "imputed_intensity_matrix.csv"))
