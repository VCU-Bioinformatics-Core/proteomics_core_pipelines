#!/usr/bin/env Rscript
# ==========================
# Protein-level differential abundance — CLI entry point
# ==========================
# This is a thin wrapper. All analysis logic lives in R/pipeline.R.
# Load the package, parse arguments, and call run_regular_pipeline().
#
...
#
# Usage:
#   Rscript inst/scripts/de.regular.R --runid <id> --counts <path> --samplesheet <path> --outdir <dir> --annotation human
